...
Передачу сделал поверх UDP с длинной окна 4 тайм аутом 500мс и размером пакета 1024 байта. Также сделал симуляцию потери пакетов

Логи клиента:
![img](s1.png)
![img](s2.png)

Логи сервера, а также можно увидеть что input и output файлы совпали:
![img](s3.png)
