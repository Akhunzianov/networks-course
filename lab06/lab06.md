...
Подключаемся к серверу через клиента
![img](s3.png)

Пока что папка на сервере пуста
![img](s4.png)

Создаем файл через клиента
![img](s5.png)
![img](s6.png)

Видим что в папке сервера он создался
![img](s7.png)

Создаем папку через клиента
![img](s8.png)
![img](s9.png)
![img](s10.png)

Видим что в папке сервера онa создалась
![img](s11.png)

Отредактируем файл через клиента
![img](s12.png)
![img](s13.png)

Видим что в папке сервера он тоже отредактировался
![img](s14.png)

Удалим файл через клиента
![img](s15.png)
![img](s16.png)

Видим что в папке сервера он тоже удалился 
![img](s17.png)
...
#### Демонстрация работы
Реализовано с бонусом в папке ftp_client. Демонстрация работы с сервером из прошлого задания
![img](t1.png)
