...
2. Можете ли вы сказать, загрузил ли ваш браузер два изображения последовательно или
   ...
   - Если бы загрузка была параллельной, вы бы увидели, что GET-запросы на оба изображения отправлены почти одновременно и их ответы/сегменты TCP заметно перемешаны по времени.
